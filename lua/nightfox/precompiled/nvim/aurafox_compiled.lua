...
vim.api.nvim_set_hl(0, "AerialGuide", { fg = "#8464c6" })
vim.api.nvim_set_hl(0, "AerialLine", { link = "Search" })
vim.api.nvim_set_hl(0, "Bold", { bold = true })
vim.api.nvim_set_hl(0, "Boolean", { link = "Number" })
vim.api.nvim_set_hl(0, "BufferCurrent", { bg = "#8464c6", fg = "#cdccce" })
vim.api.nvim_set_hl(0, "BufferCurrentIndex", { bg = "#8464c6", fg = "#569fba" })
vim.api.nvim_set_hl(0, "BufferCurrentMod", { bg = "#8464c6", fg = "#f6c177" })
vim.api.nvim_set_hl(0, "BufferCurrentSign", { bg = "#8464c6", fg = "#569fba" })
vim.api.nvim_set_hl(0, "BufferCurrentTarget", { bg = "#8464c6", fg = "#eb6f92" })
vim.api.nvim_set_hl(0, "BufferInactive", { bg = "#110f18", fg = "#3d375e" })
vim.api.nvim_set_hl(0, "BufferInactiveIndex", { bg = "#110f18", fg = "#3d375e" })
vim.api.nvim_set_hl(0, "BufferInactiveMod", { bg = "#110f18", fg = "#332a26" })
vim.api.nvim_set_hl(0, "BufferInactiveSign", { bg = "#110f18", fg = "#3d375e" })
vim.api.nvim_set_hl(0, "BufferInactiveTarget", { bg = "#110f18", fg = "#eb6f92" })
vim.api.nvim_set_hl(0, "BufferTabpage", { bg = "#110f18", fg = "#3d375e" })
vim.api.nvim_set_hl(0, "BufferTabpages", { bg = "#110f18" })
vim.api.nvim_set_hl(0, "BufferVisible", { bg = "#110f18", fg = "#cdccce" })
vim.api.nvim_set_hl(0, "BufferVisibleIndex", { bg = "#110f18", fg = "#569fba" })
vim.api.nvim_set_hl(0, "BufferVisibleMod", { bg = "#110f18", fg = "#f6c177" })
vim.api.nvim_set_hl(0, "BufferVisibleSign", { bg = "#110f18", fg = "#569fba" })
vim.api.nvim_set_hl(0, "BufferVisibleTarget", { bg = "#110f18", fg = "#eb6f92" })
vim.api.nvim_set_hl(0, "Character", { link = "String" })
vim.api.nvim_set_hl(0, "CmpDocumentation", { bg = "#110f18", fg = "#cdccce" })
vim.api.nvim_set_hl(0, "CmpDocumentationBorder", { bg = "#110f18", fg = "#433c59" })
vim.api.nvim_set_hl(0, "CmpItemAbbr", { fg = "#cdccce" })
vim.api.nvim_set_hl(0, "CmpItemAbbrDeprecated", { fg = "#8464c6", strikethrough = true })
...
vim.api.nvim_set_hl(0, "CmpItemKindDefault", { fg = "#15141b" })
...
vim.api.nvim_set_hl(0, "CmpItemKindSnippet", { fg = "#15141b" })
...
vim.api.nvim_set_hl(0, "ColorColumn", { bg = "#8464c6" })
vim.api.nvim_set_hl(0, "Comment", { fg = "#3d375e" })
vim.api.nvim_set_hl(0, "Conceal", { fg = "#8464c6" })
vim.api.nvim_set_hl(0, "Conditional", { fg = "#ccb1ed" })
vim.api.nvim_set_hl(0, "Constant", { fg = "#f0a4a2" })
vim.api.nvim_set_hl(0, "CurSearch", { link = "IncSearch" })
vim.api.nvim_set_hl(0, "Cursor", { bg = "#cdccce", fg = "#110f18" })
vim.api.nvim_set_hl(0, "CursorColumn", { link = "CursorLine" })
vim.api.nvim_set_hl(0, "CursorIM", { link = "Cursor" })
vim.api.nvim_set_hl(0, "CursorLine", { bg = "#3d375e" })
...
vim.api.nvim_set_hl(0, "DapUIBreakpointsDisabledLine", { fg = "#3d375e" })
...
vim.api.nvim_set_hl(0, "DapUIDecoration", { fg = "#8464c6" })
...
vim.api.nvim_set_hl(0, "DiagnosticVirtualTextError", { bg = "#321d2a", fg = "#eb6f92" })
vim.api.nvim_set_hl(0, "DiagnosticVirtualTextHint", { bg = "#272929", fg = "#a3be8c" })
vim.api.nvim_set_hl(0, "DiagnosticVirtualTextInfo", { bg = "#1b2530", fg = "#569fba" })
vim.api.nvim_set_hl(0, "DiagnosticVirtualTextWarn", { bg = "#332a26", fg = "#f6c177" })
vim.api.nvim_set_hl(0, "DiagnosticWarn", { fg = "#f6c177" })
vim.api.nvim_set_hl(0, "DiffAdd", { bg = "#2e322f" })
vim.api.nvim_set_hl(0, "DiffChange", { bg = "#1f2c38" })
vim.api.nvim_set_hl(0, "DiffDelete", { bg = "#3d2230" })
vim.api.nvim_set_hl(0, "DiffText", { bg = "#2d4959" })
vim.api.nvim_set_hl(0, "Directory", { fg = "#65b1cd" })
vim.api.nvim_set_hl(0, "EndOfBuffer", { fg = "#110f18" })
...
vim.api.nvim_set_hl(0, "FloatBorder", { fg = "#8464c6" })
vim.api.nvim_set_hl(0, "FocusedSymbol", { link = "Search" })
vim.api.nvim_set_hl(0, "FoldColumn", { fg = "#8464c6" })
vim.api.nvim_set_hl(0, "Folded", { bg = "#8464c6", fg = "#8464c6" })
...
vim.api.nvim_set_hl(0, "HopUnmatched", { fg = "#3d375e" })
...
vim.api.nvim_set_hl(0, "Keyword", { fg = "#8464c6" })
vim.api.nvim_set_hl(0, "Label", { link = "Conditional" })
vim.api.nvim_set_hl(0, "LightspeedGreyWash", { fg = "#3d375e" })
vim.api.nvim_set_hl(0, "LineNr", { fg = "#8464c6" })
vim.api.nvim_set_hl(0, "LspCodeLens", { fg = "#3d375e" })
vim.api.nvim_set_hl(0, "LspCodeLensSeparator", { fg = "#8464c6" })
vim.api.nvim_set_hl(0, "LspFloatWinBorder", { fg = "#8464c6" })
vim.api.nvim_set_hl(0, "LspFloatWinNormal", { bg = "#110f18" })
...
vim.api.nvim_set_hl(0, "LspSagaCodeActionBorder", { fg = "#8464c6" })
vim.api.nvim_set_hl(0, "LspSagaCodeActionContent", { link = "String" })
vim.api.nvim_set_hl(0, "LspSagaCodeActionTitle", { link = "Title" })
vim.api.nvim_set_hl(0, "LspSagaDefPreviewBorder", { fg = "#8464c6" })
vim.api.nvim_set_hl(0, "LspSagaFinderSelection", { fg = "#433c59" })
vim.api.nvim_set_hl(0, "LspSagaHoverBorder", { fg = "#8464c6" })
vim.api.nvim_set_hl(0, "LspSagaRenameBorder", { fg = "#8464c6" })
vim.api.nvim_set_hl(0, "LspSagaSignatureHelpBorder", { fg = "#eb6f92" })
vim.api.nvim_set_hl(0, "LspSignatureActiveParameter", { fg = "#63577d" })
vim.api.nvim_set_hl(0, "LspTroubleCount", { bg = "#8464c6", fg = "#c4a7e7" })
vim.api.nvim_set_hl(0, "LspTroubleNormal", { bg = "#110f18", fg = "#8464c6" })
vim.api.nvim_set_hl(0, "LspTroubleText", { fg = "#15141b" })
...
vim.api.nvim_set_hl(0, "NeoTreeFileName", { fg = "#15141b" })
vim.api.nvim_set_hl(0, "NeoTreeFileNameOpened", { fg = "#cdccce" })
...
vim.api.nvim_set_hl(0, "NeoTreeGitIgnored", { fg = "#3d375e" })
vim.api.nvim_set_hl(0, "NeoTreeGitModified", { fg = "#f6c177" })
vim.api.nvim_set_hl(0, "NeoTreeGitUntracked", { fg = "#a580d2" })
vim.api.nvim_set_hl(0, "NeoTreeIndentMarker", { fg = "#8464c6" })
vim.api.nvim_set_hl(0, "NeoTreeNormal", { bg = "#110f18", fg = "#cdccce" })
...
vim.api.nvim_set_hl(0, "NeogitDiffAddHighlight", { bg = "#2e322f" })
vim.api.nvim_set_hl(0, "NeogitDiffContextHighlight", { bg = "#1f2c38" })
vim.api.nvim_set_hl(0, "NeogitDiffDelete", { fg = "#eb6f92" })
vim.api.nvim_set_hl(0, "NeogitDiffDeleteHighlight", { bg = "#3d2230" })
vim.api.nvim_set_hl(0, "NeogitHunkHeader", { bg = "#3d375e", fg = "#569fba" })
...
vim.api.nvim_set_hl(0, "NonText", { fg = "#8464c6" })
vim.api.nvim_set_hl(0, "Normal", { bg = "#110f18", fg = "#cdccce" })
vim.api.nvim_set_hl(0, "NormalFloat", { bg = "#110f18", fg = "#cdccce" })
vim.api.nvim_set_hl(0, "NormalNC", { bg = "#110f18", fg = "#cdccce" })
vim.api.nvim_set_hl(0, "NotifyDEBUGBorder", { fg = "#5a6652" })
vim.api.nvim_set_hl(0, "NotifyDEBUGIcon", { link = "NotifyDEBUGTitle" })
vim.api.nvim_set_hl(0, "NotifyDEBUGTitle", { fg = "#a3be8c" })
vim.api.nvim_set_hl(0, "NotifyERRORBorder", { fg = "#7e3f55" })
vim.api.nvim_set_hl(0, "NotifyERRORIcon", { link = "NotifyERRORTitle" })
vim.api.nvim_set_hl(0, "NotifyERRORTitle", { fg = "#eb6f92" })
vim.api.nvim_set_hl(0, "NotifyINFOBorder", { fg = "#345769" })
vim.api.nvim_set_hl(0, "NotifyINFOIcon", { link = "NotifyINFOTitle" })
vim.api.nvim_set_hl(0, "NotifyINFOTitle", { fg = "#569fba" })
vim.api.nvim_set_hl(0, "NotifyTRACEBorder", { fg = "#8464c6" })
vim.api.nvim_set_hl(0, "NotifyTRACEIcon", { link = "NotifyTRACETitle" })
vim.api.nvim_set_hl(0, "NotifyTRACETitle", { fg = "#3d375e" })
vim.api.nvim_set_hl(0, "NotifyWARNBorder", { fg = "#846848" })
vim.api.nvim_set_hl(0, "NotifyWARNIcon", { link = "NotifyWARNTitle" })
vim.api.nvim_set_hl(0, "NotifyWARNTitle", { fg = "#f6c177" })
vim.api.nvim_set_hl(0, "Number", { fg = "#54c59f" })
vim.api.nvim_set_hl(0, "NvimTreeEmptyFolderName", { fg = "#8464c6" })
...
vim.api.nvim_set_hl(0, "NvimTreeIndentMarker", { fg = "#8464c6" })
vim.api.nvim_set_hl(0, "NvimTreeNormal", { bg = "#110f18", fg = "#cdccce" })
...
vim.api.nvim_set_hl(0, "Operator", { fg = "#eae8ff" })
vim.api.nvim_set_hl(0, "Pmenu", { bg = "#433c59", fg = "#cdccce" })
...
vim.api.nvim_set_hl(0, "PounceAccept", { bg = "#f0a4a2", fg = "#110f18" })
vim.api.nvim_set_hl(0, "PounceAcceptBest", { bg = "#a6dae3", fg = "#110f18" })
vim.api.nvim_set_hl(0, "PounceGap", { bg = "#433c59", fg = "#cdccce" })
vim.api.nvim_set_hl(0, "PounceMatch", { bg = "#63577d", fg = "#cdccce" })
vim.api.nvim_set_hl(0, "PreCondit", { link = "PreProc" })
vim.api.nvim_set_hl(0, "PreProc", { fg = "#61ffca" })
...
vim.api.nvim_set_hl(0, "Search", { bg = "#63577d", fg = "#cdccce" })
vim.api.nvim_set_hl(0, "SignColumn", { fg = "#8464c6" })
vim.api.nvim_set_hl(0, "SignColumnSB", { link = "SignColumn" })
vim.api.nvim_set_hl(0, "Sneak", { bg = "#c4a7e7", fg = "#110f18" })
...
vim.api.nvim_set_hl(0, "Statement", { fg = "#8464c6" })
vim.api.nvim_set_hl(0, "StatusLine", { bg = "#110f18", fg = "#15141b" })
vim.api.nvim_set_hl(0, "StatusLineNC", { bg = "#110f18", fg = "#8464c6" })
vim.api.nvim_set_hl(0, "StorageClass", { link = "Type" })
vim.api.nvim_set_hl(0, "String", { fg = "#61ffca" })
vim.api.nvim_set_hl(0, "Structure", { link = "Type" })
vim.api.nvim_set_hl(0, "Substitute", { bg = "#eb6f92", fg = "#110f18" })
...
vim.api.nvim_set_hl(0, "TSConstructor", { fg = "#8464c6" })
...
vim.api.nvim_set_hl(0, "TSKeywordOperator", { bold = true, fg = "#eae8ff" })
vim.api.nvim_set_hl(0, "TSNamespace", { fg = "#a6dae3" })
vim.api.nvim_set_hl(0, "TSNote", { fg = "#569fba" })
vim.api.nvim_set_hl(0, "TSOperator", { fg = "#eae8ff" })
vim.api.nvim_set_hl(0, "TSProperty", { link = "TSField" })
vim.api.nvim_set_hl(0, "TSPunctBracket", { fg = "#eae8ff" })
vim.api.nvim_set_hl(0, "TSPunctDelimiter", { fg = "#eae8ff" })
vim.api.nvim_set_hl(0, "TSPunctSpecial", { fg = "#eae8ff" })
vim.api.nvim_set_hl(0, "TSStringEscape", { bold = true, fg = "#f9cb8c" })
vim.api.nvim_set_hl(0, "TSStringRegex", { fg = "#f9cb8c" })
vim.api.nvim_set_hl(0, "TSTextReference", { fg = "#8464c6" })
...
vim.api.nvim_set_hl(0, "TabLine", { bg = "#8464c6", fg = "#8464c6" })
vim.api.nvim_set_hl(0, "TabLineFill", { bg = "#110f18" })
vim.api.nvim_set_hl(0, "TabLineSel", { bg = "#8464c6", fg = "#15141b" })
vim.api.nvim_set_hl(0, "Tag", { link = "Special" })
vim.api.nvim_set_hl(0, "TelescopeBorder", { fg = "#8464c6" })
...
vim.api.nvim_set_hl(0, "Todo", { bg = "#569fba", fg = "#110f18" })
vim.api.nvim_set_hl(0, "Type", { fg = "#f6c177" })
vim.api.nvim_set_hl(0, "Typedef", { link = "Type" })
vim.api.nvim_set_hl(0, "Underlined", { underline = true })
vim.api.nvim_set_hl(0, "VertSplit", { fg = "#8464c6" })
...
vim.api.nvim_set_hl(0, "WhichKeyFloat", { bg = "#110f18" })
...
vim.api.nvim_set_hl(0, "WinBar", { bg = "#110f18", bold = true, fg = "#8464c6" })
vim.api.nvim_set_hl(0, "WinBarNC", { bg = "#110f18", bold = true, fg = "#8464c6" })
...
vim.api.nvim_set_hl(0, "diffIndexLine", { fg = "#61ffca" })
...
vim.api.nvim_set_hl(0, "rustTSField", { fg = "#15141b" })

-- This is a hack as currently `nvim_set_hl` returns `{ [true] = 6 }`
-- if `Normal` is requested from `nvim_get_hl_by_name("Normal", true)`
vim.cmd("highlight Normal guifg=#cdccce guibg=#110f18 gui=NONE guisp=NONE")
